(defsystem parseq
  ...
  :homepage "https://github.com/bohonghuang/parseq"
  :bug-tracker "https://github.com/bohonghuang/parseq/issues"
  :source-control (:git "https://github.com/bohonghuang/parseq.git")
